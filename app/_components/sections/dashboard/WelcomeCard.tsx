...
export const WelcomeCard = ({ user }: WelcomeCardProps) => {
  return (
    <div className="relative bg-white md:rounded-2xl shadow-lg md:border md:border-gray-200 overflow-hidden">
      <div className="h-40 md:h-48 bg-gradient-to-r from-[#EA580C] to-orange-600" />
      <div className="p-6">
        <div className="flex justify-between items-start -mt-20 md:-mt-24">
          <div className="w-28 h-28 md:w-32 md:h-32 bg-slate-200 rounded-full flex items-center justify-center text-5xl font-bold border-4 border-white shadow-md flex-shrink-0">
        ...
        <div className="mt-4">
          <h2 className="text-2xl font-bold text-[#EA580C]">{user.name}</h2>
          <p className="text-md text-[#64748B]">{user.university}</p>
        </div>
