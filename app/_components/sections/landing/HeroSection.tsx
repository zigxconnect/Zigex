        ...
        <div className="text-center max-w-4xl mx-auto">
          ...
          >
            <h1 className="text-4xl sm:text-5xl lg:text-6xl font-bold text-white mb-6 leading-tight">
              ...
              <span className="text-orange-500 animate-pulse">Bamenda</span>
            </h1>
          </div>
          ...
          >
            <p className="text-lg sm:text-xl text-blue-100 mb-8 max-w-2xl mx-auto leading-relaxed">
              Discover amazing internship opportunities with top companies in
              Bamenda. Start your professional journey today and build the
              future you deserve.
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 max-w-5xl mx-auto">
            {features.map((feature, index) => {
              ...
              return (
                ...
                >
                  <div
                    className={`group relative p-8 rounded-2xl backdrop-blur-sm bg-white/5 border border-white/10 hover:bg-white/10 transition-all duration-500 hover:scale-105 hover:shadow-2xl ${
                  ...
                  >
                    ...
                    <div className="relative z-10 mb-6">
                      <div
                        className={`w-16 h-16 mx-auto rounded-full bg-gradient-to-br ${feature.color} flex items-center justify-center transform group-hover:scale-110 group-hover:rotate-3 transition-all duration-300`}
                      >
