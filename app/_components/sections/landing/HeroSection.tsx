...
import { Clock, Building2, Zap, ArrowRight, Sparkles, Users, TrendingUp, MapPin, Star, Play } from 'lucide-react';
...
const BamendaHeroSection: React.FC = () => {
  ...
  const features: Feature[] = [
    {
      ...
      description: "Live opportunities updated daily across Bamenda's growing business ecosystem",
    ...
    },
    {
      ...
      description: "From startups to established enterprises, connect with Bamenda's top employers",
    ...
    },
    {
      ...
      description: "Our AI-powered matching system gets you hired 50% faster than traditional methods",
  ...
  const stats: StatCard[] = [
    { icon: Users, value: "2,500+", label: "Students Placed", color: "text-emerald-500" },
    { icon: Building2, value: "85%", label: "Job Success Rate", color: "text-blue-500" },
    { icon: MapPin, value: "50+", label: "Locations Covered", color: "text-orange-500" },
    { icon: Star, value: "4.9", label: "Average Rating", color: "text-yellow-500" }
  ];

  const testimonials = [
    { name: "Adeline Fomukong", role: "Software Engineering Intern", company: "TechBam Solutions", quote: "Found my dream internship in just 5 days!" },
    { name: "Boris Ngwa", role: "Marketing Intern", company: "Bamenda Digital", quote: "The platform made networking so much easier." },
    { name: "Grace Nkeng", role: "Finance Intern", company: "Northwest Bank", quote: "Professional growth beyond my expectations." }
  ];
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-50 via-blue-50 to-indigo-100 relative overflow-hidden">
      ...
      <div className="absolute inset-0 overflow-hidden">
        ...
        <div className="absolute top-40 right-20 w-16 h-16 bg-gradient-to-br from-blue-400 to-indigo-500 rounded-full opacity-10 animate-float" style={{ animationDelay: '1s' }}></div>
        <div className="absolute bottom-40 left-20 w-32 h-32 bg-gradient-to-br from-emerald-400 to-teal-500 rounded-3xl opacity-10 animate-float" style={{ animationDelay: '2s' }}></div>
      </div>
      ...
      <div className="relative z-10 container mx-auto px-4 py-8 sm:py-12 lg:py-16">
        ...
        {/* Top Stats Bar */}
        <div className={`transform transition-all duration-1000 ${isVisible ? 'translate-y-0 opacity-100' : 'translate-y-5 opacity-0'}`}>
          <div className="grid grid-cols-2 lg:grid-cols-4 gap-4 mb-12 max-w-4xl mx-auto">
            {stats.map((stat, index) => {
              const Icon = stat.icon;
              return (
                <div key={index} className="bg-white/80 backdrop-blur-sm rounded-xl p-4 text-center border border-white/20 shadow-lg hover:shadow-xl transition-all duration-300">
            ...
            <div className={`transform transition-all duration-1000 delay-500 ${isVisible ? 'translate-y-0 opacity-100' : 'translate-y-10 opacity-0'}`}>
              <div className="flex items-center gap-6 pt-4">
                ...
                <div>
                  ...
                  <p className="text-sm text-gray-600">Trusted by 2,500+ students</p>
                </div>
              </div>
            </div>
          </div>
            ...
            <div className="relative">
              ...
              <div className="bg-white rounded-2xl shadow-2xl overflow-hidden border border-gray-200">
                ...
                <div className="bg-gradient-to-r from-gray-50 to-gray-100 px-6 py-4 border-b border-gray-200">
                  <div className="flex items-center justify-between">
                    ...
                    <div className="text-sm text-gray-600">Bamenda Internships Dashboard</div>
                  </div>
                </div>
              ...
              <div className="absolute -right-4 -bottom-4 bg-white rounded-xl shadow-xl p-4 border border-gray-200 animate-float">
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    <div className="font-semibold text-gray-800 text-sm">+{Math.floor(Math.random() * 50) + 20} New Jobs</div>
        ...
        <div className="mt-20 max-w-6xl mx-auto">
          <div className={`text-center mb-12 transform transition-all duration-1000 delay-700 ${isVisible ? 'translate-y-0 opacity-100' : 'translate-y-10 opacity-0'}`}>
            ...
            <p className="text-lg text-gray-600 max-w-2xl mx-auto">
              We've revolutionized the internship experience in Bamenda with cutting-edge technology and local expertise.
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {features.map((feature, index) => {
              ...
              return (
                ...
                >
                  <div className={`group relative p-8 rounded-2xl bg-white/80 backdrop-blur-sm border border-white/20 shadow-lg hover:shadow-xl transition-all duration-500 hover:scale-105 ${hoveredFeature === index ? 'shadow-2xl' : ''}`}>
                    ...
                    <div className="relative z-10 mb-6">
                      <div className="flex items-center justify-between mb-4">
                        <div className={`w-16 h-16 rounded-2xl bg-gradient-to-br ${feature.color} flex items-center justify-center transform group-hover:scale-110 group-hover:rotate-3 transition-all duration-300`}>
                          <Icon className="w-8 h-8 text-white" />
                        </div>
                        {feature.metric && (
                          <div className="text-right">
                            <div className="text-sm font-bold text-gray-800">{feature.metric}</div>
                    ...
                    {/* Hover Border Effect */}
                    <div className={`absolute inset-0 rounded-2xl border-2 border-transparent group-hover:border-gradient transition-all duration-300`}
                         style={{ borderImage: hoveredFeature === index ? `linear-gradient(135deg, ${feature.color.replace('from-', '').replace('to-', ', ')}) 1` : 'none' }}></div>
                  </div>
                </div>
              );
            })}
        ...
        <div className={`mt-20 text-center transform transition-all duration-1000 delay-1000 ${isVisible ? 'translate-y-0 opacity-100' : 'translate-y-10 opacity-0'}`}>
          <div className="max-w-4xl mx-auto">
            <h3 className="text-2xl font-bold text-gray-900 mb-8">Success Stories from Bamenda</h3>
            <div className="bg-white/80 backdrop-blur-sm rounded-2xl p-8 shadow-xl border border-white/20">
              ...
              <div className="text-sm text-gray-600">{testimonials[currentSlide].role} at {testimonials[currentSlide].company}</div>
            </div>
          </div>
        </div>
      </div>
      ...
      <style jsx>{`
        ...
        @keyframes grow {
          0% { height: 0%; }
          100% { height: var(--final-height, 80%); }
        }
