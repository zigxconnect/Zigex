        ...
        <div className="flex items-center justify-between p-6 border-b border-gray-200 bg-gradient-to-r from-blue-50 to-indigo-100 rounded-t-2xl">
          <div>
            ...
            <p className="text-xs text-gray-500">
              Company: {application.internship?.company || "Company"}
            </p>
          </div>
          <button
            onClick={onClose}
        ...
        <div className="p-6 space-y-6">
          ...
          <div className="bg-gray-50 rounded-xl p-4 shadow-sm">
            ...
            {application.form?.cover_letter_url ? (
              <a
                href={application.form.cover_letter_url}
                target="_blank"
                rel="noopener"
          ...
          <div className="bg-gray-50 rounded-xl p-4 shadow-sm">
            ...
            {application.form?.support_letter_url ? (
              <a
                href={application.form.support_letter_url}
                target="_blank"
                rel="noopener"
                className="inline-flex items-center gap-2 text-indigo-700 font-medium hover:underline"
              >
                <FileText size={16} /> View submitted PDF
              </a>
            ) : (
              <span className="text-gray-500">
                No support letter submitted.
              </span>
            )}
          </div>
        </div>
  ...
  const handleSave = async () => {
    ...
    try {
      ...
      if (supportLetterFile)
        formDataToSend.append("support_letter_file", supportLetterFile);
        ...
        <div className="p-6 space-y-4">
          ...
          <div>
            ...
            {formData.form?.cover_letter_url && (
              <a
                href={formData.form.cover_letter_url}
                target="_blank"
                rel="noopener"
          ...
          <div>
            ...
            <FileUploadButton
              value={supportLetterFile}
              onChange={setSupportLetterFile}
            />
            {formData.form?.support_letter_url && (
              <a
                href={formData.form.support_letter_url}
                target="_blank"
                rel="noopener"
                className="text-blue-600 text-xs mt-2 block"
              >
            ...
            >
              <div className="p-6">
                ...
                <div className="space-y-2 text-sm text-gray-600 mb-4">
                  ...
                  <div className="flex items-center gap-2">
                    <Clock size={14} /> {app.internship?.duration || "-"}
                  </div>
                  <div className="font-medium text-green-600">
                    {app.internship?.salary || ""}
                  </div>
                </div>
                <div className="mt-4">
