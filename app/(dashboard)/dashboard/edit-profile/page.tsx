...
export default function EditProfilePage() {
  ...
  const methods = useForm<ProfileFormData>({ mode: "onBlur" });
  ...
  // Map step index to relevant field names for validation
  const stepFields: string[][] = [
    ["firstName", "lastName", "email", "phone"], // Step 0: Personal Info
    ["education"], // Step 1: Education
    ["skills"], // Step 2: Skills
    ["experience"], // Step 3: Experience
    ["additional"], // Step 4: Additional
  ];
  ...
  const handleNext = async () => {
    ...
    if (!valid) return; // Prevent navigation if validation fails
  ...
  const onSubmit = async (data: ProfileFormData) => {
    ...
    try {
      // Only send non-sensitive fields (omit passwords/PII)
      const { password, ...safeData } = data;
      // Replace with your actual endpoint and method
      ...
      // Optionally drive animation by API response
      setTimeout(() => {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-50 via-white to-gray-50 relative overflow-hidden">
      ...
      <div className="absolute inset-0 overflow-hidden pointer-events-none">
        ...
        <div
          className="absolute -bottom-40 -left-40 w-96 h-96 bg-gradient-to-r from-orange-500/10 to-orange-600/10 rounded-full blur-3xl animate-pulse"
      ...
      <div className="relative z-10 max-w-4xl mx-auto p-6 py-10">
        ...
        <div className="flex items-center mb-8 transform hover:scale-105 transition-transform duration-300">
          ...
          >
            <ArrowLeft
              size={24}
              className="text-slate-600 group-hover:text-blue-900 transition-colors"
            />
          </button>
          <div className="ml-4">
              ...
              return (
                ...
                >
                  ...
                  {idx < steps.length - 1 && (
                    <ChevronRight
                      size={16}
                      className="text-gray-300 mx-1 flex-shrink-0"
                    />
                  )}
                </div>
              );
        ...
        <div className="bg-white/80 backdrop-blur-sm rounded-3xl shadow-xl border border-white/50 overflow-hidden">
          ...
          >
            ...
            <h2 className="text-2xl font-bold text-gray-800 mb-6 flex items-center gap-3">
              <div
                className={`p-2 rounded-xl bg-gradient-to-r ${steps[activeStep].color}`}
              >
