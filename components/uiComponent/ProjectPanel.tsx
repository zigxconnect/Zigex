    ...
    return (
      <aside className="md:fixed md:right-6 md:top-32 w-full md:w-72 lg:w-80 bg-[#F6F8FF] rounded-[2.5rem] border border-blue-100 shadow-xl overflow-hidden p-8 text-center border-dashed border-2">
        ...
        <div className="space-y-3">
          ...
          {user.linkedin_url && (
            <Button asChild variant="secondary" className="w-full h-11 border-blue-100 text-[#155DFC] hover:bg-blue-50 rounded-xl font-bold">
          ...
          <div className="space-y-3">
            ...
            <div className="grid grid-cols-2 gap-3">
              {project.github_repository && (
                <Button asChild variant="secondary" className="h-11 border-slate-100 hover:border-slate-300 text-slate-700 rounded-xl font-bold">
                  <a href={project.github_repository} target="_blank" rel="noopener noreferrer">
                    <Github size={16} className="mr-2" /> Code
                  </a>
                </Button>
              )}
              <Button variant="secondary" className={`${!project.github_repository ? 'col-span-2' : ''} h-11 border-slate-100 hover:border-slate-300 text-slate-700 rounded-xl font-bold`}>
        ...
        <div className="md:hidden fixed inset-0 z-[60] animate-in fade-in duration-300">
          ...
          <div className="absolute bottom-0 left-0 right-0 bg-white rounded-t-[3rem] p-8 max-h-[85vh] overflow-y-auto animate-in slide-in-from-bottom-full duration-500">
            ...
            <div className="space-y-3 pb-8">
              ...
              {whatsappUrl && (
                <Button asChild variant="secondary" className="w-full h-14 border-blue-100 text-[#155DFC] rounded-2xl font-bold">
