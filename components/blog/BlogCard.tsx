          ...
          <div className="space-y-3">
            ...
            {item.excerpt && (
              isAnnouncement ? (
                <RichContentRenderer 
                  content={item.excerpt}
                  className="text-slate-600 dark:text-slate-400 text-xs sm:text-sm line-clamp-3 [&_p]:text-slate-600 dark:[&_p]:text-slate-400 [&_h1]:text-slate-900 dark:[&_h1]:text-white [&_h2]:text-slate-900 dark:[&_h2]:text-white [&_h3]:text-slate-900 dark:[&_h3]:text-white [&_strong]:text-slate-700 dark:[&_strong]:text-slate-300 [&_em]:text-slate-600 dark:[&_em]:text-slate-400 [&_a]:text-blue-600 dark:[&_a]:text-blue-400"
                />
              ) : (
